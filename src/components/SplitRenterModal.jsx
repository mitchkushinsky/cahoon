...
function RenterSection({ renter, index, isAdmin, onRefresh, isDemo, onDemoWrite }) {
  const { renterInfo, totalRent, leaseStatus, leaseUrl, rentalId, smartLockCombo } = renter
    ...
    <div className="p-5 space-y-5 pb-8">
      ...
      {isAdmin && (
        <div className="border-t border-gray-100 pt-5 space-y-2">
          <h3 className="text-sm font-semibold text-gray-700">Owner Notes (shared)</h3>
          <textarea
            value={commentText}
